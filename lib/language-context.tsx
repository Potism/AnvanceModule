...
export const translations: Translations = {
  ...
  "svc.video.cinematicDesc": { it: "Spot commerciali, brand film, corporate", en: "Commercials, brand films, corporate" },
  ...
  "pricing.videoCine": { it: "Video cinematic / corporate (€)", en: "Cinematic / corporate video (€)" },
  "pricing.videoCineMonthly": {
    it: "Video corporate — canone mensile (€, 0 = come progetto)",
    en: "Corporate video — monthly retainer (€, 0 = same as project)",
  },
  ...
  "pricing.billCine": { it: "Video cinematic / corporate", en: "Cinematic / corporate video" },
